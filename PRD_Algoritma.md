...
## 2. Pemilihan Algoritma & Justifikasi Teknis

### 2.1 Model Utama: XGBoost Multi-Output Regressor
...
### 2.2 Analisis Komparasi Algoritma
...
### 4.2 Daftar Target Output ($Y$) — Matriks 9 Dimensi
...
## 5. Strategi Multi-Horizon: Mengapa $T+1, T+2,$ dan $T+3$ Muncul Bersama?
...
## 6. Bayesian Optimization Hyperparameter Tuning (Optuna TPE)
...
### 6.1 Ruang Pencarian Hyperparameter (*Search Space*)
...
### 6.2 Skema Validasi: 5-Fold Time-Series Split
...
## 7. Metrik Evaluasi Kinerja Model
...
### 7.2 Hasil Uji Evaluasi Terverifikasi (Baseline Benchmark)
...
## 8. MLOps & Arsitektur Cloud Deployment
...
## 9. Penanganan Error & Mekanisme *Fail-Safe*
...
## 10. Persetujuan & Dokumen Terkait
